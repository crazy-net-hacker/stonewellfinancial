...
// banner Title
const bannerTitle = [<Text tid={`Coming to Canada`} />]
const faqLists = [
  {
...
export default function TravelInbound({match}) { 
  const metaData = {
    title: 'Meta.TravelInsurace.Inbound.Title',
    description: 'Meta.TravelInsurace.Inbound.Description',
    canonical: match.url
  }
