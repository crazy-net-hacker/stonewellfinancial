...
export default function OptimizedPlan(props) {
  ...
  //  console.log(data)
    ...
    for (var i = 0; i < data.insuredPersons.length; i++) {
        ...
        let eligilbeAllianzPlan = false
        if(data.originProvince === 'ON' || data.originProvince === 'QC' || data.destProvince === 'ON' || data.destProvince === 'QC')
        {eligilbeAllianzPlan = true}
        ...
        if (data.insuredPersons[i].eligilbeIns === 'STUDENT') 
        {
          ...
          eligilbePlans = insurances.filter(ins => (ins.insured_type === insuredEligilbeIns)
                                                        ...
                                                        //       : ins.compnay_name !== '')
                                                        && (inDestination === true
                                                              ? (ins.compnay_name === 'Allianz' && (eligilbeAllianzPlan === true))
        ...
        // get insurace plan by optimized insurance  
